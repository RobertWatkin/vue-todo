...
const todoCompleted = computed(() => { // computed properties automatically update when the data they depend on changes
  return todoList.value.every((todo) => todo.isCompleted); // returns true if every todo is completed
});
